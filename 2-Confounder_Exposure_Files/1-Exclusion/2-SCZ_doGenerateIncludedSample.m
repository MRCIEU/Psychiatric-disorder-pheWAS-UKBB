...
snpScore=dataset('file',strcat(dataDir,'data/PRS/SCZ_snp-p1-score-withPhenIds.csv'),'delimiter',',');
...
export(snpScore, 'file',strcat(mydir,'SCZ_snp-score-p1-withPhenIds-subset.csv'),'delimiter',',');
