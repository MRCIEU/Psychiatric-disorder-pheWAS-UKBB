...
snpScore=dataset('file',strcat(dataDir,'data/PRS/ASD_snp-p1-score-withPhenIds.csv'),'delimiter',',');
...
export(snpScore, 'file',strcat(mydir,'ASD_snp-score-p1-withPhenIds-subset.csv'),'delimiter',',');
