...
snpScore=dataset('file',strcat(dataDir,'data/PRS/ADHD_snp-p1-score-withPhenIds.csv'),'delimiter',',');
...
export(snpScore, 'file',strcat(mydir,'ADHD_snp-score-p1-withPhenIds-subset.csv'),'delimiter',',');
