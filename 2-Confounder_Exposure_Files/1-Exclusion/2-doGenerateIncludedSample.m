...
snpScore=dataset('file',strcat(dataDir,'data/PRS/snp-score-withPhenIds.csv'),'delimiter',',');
...
export(snpScore, 'file',strcat(mydir,'snp-score-withPhenIds-subset.csv'),'delimiter',',');
