...
snpScore=dataset('file',strcat(dataDir,'data/PRS/BP_snp-p1-score-withPhenIds.csv'),'delimiter',',');
...
export(snpScore, 'file',strcat(mydir,'BP_snp-score-p1-withPhenIds-subset.csv'),'delimiter',',');
