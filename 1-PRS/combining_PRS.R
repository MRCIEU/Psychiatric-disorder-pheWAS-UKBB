...
CHR1 <- read.table(paste0(homedir,"/data/PRS/CHR1.all.score"), header = TRUE)
CHR2 <- read.table(paste0(homedir,"/data/PRS/CHR2.all.score"), header=TRUE)
CHR3 <- read.table(paste0(homedir,"/data/PRS/CHR3.all.score"), header=TRUE)
CHR4 <- read.table(paste0(homedir,"/data/PRS/CHR4.all.score"), header=TRUE)
CHR5 <- read.table(paste0(homedir,"/data/PRS/CHR5.all.score"), header=TRUE)
CHR6 <- read.table(paste0(homedir,"/data/PRS/CHR6.all.score"), header=TRUE)
CHR7 <- read.table(paste0(homedir,"/data/PRS/CHR7.all.score"), header=TRUE)
CHR8 <- read.table(paste0(homedir,"/data/PRS/CHR8.all.score"), header=TRUE)
CHR9 <- read.table(paste0(homedir,"/data/PRS/CHR9.all.score"), header=TRUE)
CHR10 <- read.table(paste0(homedir,"/data/PRS/CHR10.all.score"), header=TRUE)
CHR11 <- read.table(paste0(homedir,"/data/PRS/CHR11.all.score"), header=TRUE)
CHR12 <- read.table(paste0(homedir,"/data/PRS/CHR12.all.score"), header=TRUE)
CHR13 <- read.table(paste0(homedir,"/data/PRS/CHR13.all.score"), header=TRUE)
CHR14 <- read.table(paste0(homedir,"/data/PRS/CHR14.all.score"), header=TRUE)
CHR15 <- read.table(paste0(homedir,"/data/PRS/CHR15.all.score"), header=TRUE)
CHR16 <- read.table(paste0(homedir,"/data/PRS/CHR16.all.score"), header=TRUE)
CHR17 <- read.table(paste0(homedir,"/data/PRS/CHR17.all.score"), header=TRUE)
CHR18 <- read.table(paste0(homedir,"/data/PRS/CHR18.all.score"), header=TRUE)
CHR19 <- read.table(paste0(homedir,"/data/PRS/CHR19.all.score"), header=TRUE)
CHR20 <- read.table(paste0(homedir,"/data/PRS/CHR20.all.score"), header=TRUE)
CHR21 <- read.table(paste0(homedir,"/data/PRS/CHR21.all.score"), header=TRUE)
CHR22 <- read.table(paste0(homedir,"/data/PRS/CHR22.all.score"), header=TRUE)
...
sd <- sd(p10)
std.p10 <- (p10-avg)/sd
score.p10<- data.frame(FID,std.p10)
head(score.p10)
...
score.p9<- data.frame(FID,std.p9)
head(score.p9)
...
score.p8<- data.frame(FID,std.p8)
head(score.p8)
...
score.p7<- data.frame(FID,std.p7)
head(score.p7)
...
score.p6<- data.frame(FID,std.p6)
head(score.p6)
...
score.p5<- data.frame(FID,std.p5)
head(score.p5)
...
score.p4<- data.frame(FID,std.p4)
head(score.p4)
...
score.p3<- data.frame(FID,std.p3)
head(score.p3)
...
score.p2<- data.frame(FID,std.p2)
head(score.p2)
hist(score.p2$std.p2)

p1 <- c((CHR1$CHR1.1+CHR3$CHR3.1+CHR5$CHR5.1+CHR7$CHR7.1+CHR8$CHR8.1+CHR10$CHR10.1+CHR12$CHR12.1+CHR15$CHR15.1+CHR16$CHR16.1)/8)
avg.p1 <- mean(p1)
sd.p1 <- sd(p1)
std.p1 <- (p1-avg.p1)/sd.p1
score.p1<- data.frame(FID,std.p1)
head(score.p1)
hist(score.p1$std.p1)


write.table(score.p1,file=paste0(homedir,"/data/PRS/snp-score-p1.txt"),sep=",", row.names = FALSE)
write.table(score.p2,file=paste0(homedir,"/data/PRS/snp-score-p2.txt"),sep=",", row.names = FALSE)
write.table(score.p3,file=paste0(homedir,"/data/PRS/snp-score-p3.txt"),sep=",", row.names = FALSE)
write.table(score.p4,file=paste0(homedir,"/data/PRS/snp-score-p4.txt"),sep=",", row.names = FALSE)
write.table(score.p5,file=paste0(homedir,"/data/PRS/snp-score-p5.txt"),sep=",", row.names = FALSE)
write.table(score.p6,file=paste0(homedir,"/data/PRS/snp-score-p6.txt"),sep=",", row.names = FALSE)
write.table(score.p7,file=paste0(homedir,"/data/PRS/snp-score-p7.txt"),sep=",", row.names = FALSE)
write.table(score.p8,file=paste0(homedir,"/data/PRS/snp-score-p8.txt"),sep=",", row.names = FALSE)
write.table(score.p9,file=paste0(homedir,"/data/PRS/snp-score-p9.txt"),sep=",", row.names = FALSE)
write.table(score.p10,file=paste0(homedir,"/data/PRS/snp-score-p10.txt"),sep=",", row.names = FALSE)
