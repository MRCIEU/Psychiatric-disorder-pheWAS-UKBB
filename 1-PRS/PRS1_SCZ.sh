...
--dir . \
--base ${HOME}/GWAS_discovery/ripke-neale-corvin-2014-schizophrenia-prePRS.tsv \
--binary-target F \
--stat OR \
--type bgen \
...
--no-regress T \
--print-snp T \
--out ${PROJECTDIR}/data/PRS/SCZ_CHR$pIdx \
--extract ${PROJECTDIR}/data/PRS/SCZ_CHR$pIdx.valid \